...
public class MyAccountsTest extends Utility {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.xpath("//input[@id='input-firstname']"), "Manju");
        //3.4 Enter last name
        sendTextToElement(By.xpath("//input[@id='input-lastname']"), "Thakur");
        //3.5 Enter Email
        sendTextToElement(By.xpath("//input[@id='input-email']"), "mvthakur1984@gmail.com");
        //3.6 Enter Telephone
        sendTextToElement(By.xpath("//input[@id='input-telephone']"), "07777777000");
        //3.7 Enter Password
        sendTextToElement(By.xpath("//input[@id='input-password']"), "Mv123456");
        //3.8 Enter Password Confirm
        sendTextToElement(By.xpath("//input[@id='input-confirm']"), "Mv123456");
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.xpath("//input[@id='input-email']"), "mvthakur2011@gmail.com");
        //4.6 Enter Password
        sendTextToElement(By.xpath("//input[@id='input-password']"), "Mv123456");
